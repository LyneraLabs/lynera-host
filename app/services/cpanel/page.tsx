...
import { cpanelHostingPricing } from '@/data/pricing';
      ...
      <main className="flex-grow bg-gray-50">
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold mb-4">{cpanelHostingPricing.name}</h1>
            <p className="text-xl max-w-2xl">{cpanelHostingPricing.description}</p>
          </div>
        </section>
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {cpanelHostingPricing.tiers.map((tier) => (
                <PricingSlider
                  key={tier.name}
                  tier={tier}
            ...
            {/* Addons Section */}
            {cpanelHostingPricing.addons && cpanelHostingPricing.addons.length > 0 && (
              <div className="mt-16">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">
                  Available Add-ons
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {cpanelHostingPricing.addons.map((addon) => (
